...
<div class="container">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="cust_name" placrholder="ชื่อ-นามสกุล">
                    </div>

                    <div class="form-group">
                        <label>อีเมลล์</label>
                        <input type="text" class="form-control" id="cust_email" placrholder="อีเมลล์ของท่าน">
                    </div>
    ...
    <a href = "{{ URL::to('cart/view') }} " class="btn vtn-default">ย้อนกลับ</a>
