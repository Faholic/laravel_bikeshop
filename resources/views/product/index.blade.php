            ...
            <table class="table table-bordered bs_table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="bs_center"> 
                            <a href="{{ URL::to('product/edit/'.$p->id) }}" class="btn btn-info"><i class="fa-solid fa-pen-to-square"></i> แก้ไข</a>
                            <a href="#" class="btn btn-danger btn-delete" id-delete="{{ $p->id }}"><i class="fa-solid fa-trash-can"></i>ลบ</a>
                        </td>
                    </tr> @endforeach
                </tbody>
                <tfoot>
